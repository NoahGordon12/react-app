        ...
        <div class="block lg:flex bg-white lg:shadow-lg rounded-lg">
            ...
            <div class="w-full lg:w-2/3 px-6 py-16">
                <form onSubmit={handleOnSubmit}>
                    <div class="mb-4">
                        <label for="product name" class="block mb-2 text-sm text-gray-800">Shoes</label>
                    ...
                    <div class="block md:flex items-center justify-between">
                        <button type="submit" className="w-full py-3 mt-10 bg-gray-800 rounded-sm font-medium text-white uppercase focus:outline-none hover:bg-gray-700 hover:shadow-none">Add product</button>
                    </div>
                </form>
            </div>
        </div>
